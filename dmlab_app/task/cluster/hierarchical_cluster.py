...
from dmlab_app.db import get_db
from dmlab_app.db.dao.evaluation import Evaluation
from dmlab_app.db.dao.evaluation_file import EvaluationFile
from dmlab_app.db.models import EvaluationFileModel
from dmlab_app.extensions import get_file_client
from dmlab_app.filesystem import get_fs
from dmlab_app.utils import NpEncoder, numeric
        ...
        if success:
            ...
            if evaluation_file:
                ...
                try:
                    ...
                    dt_model = cluster.AgglomerativeClustering(n_clusters=numeric(params.get('n_clusters')),
                                                               affinity=numeric(params.get('affinity')),
                                                               linkage=numeric(params.get('linkage'))
                                                          )
