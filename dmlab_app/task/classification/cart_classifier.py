            ...
            if fs.isfile(par_data_path):
                ...
                try:
                    ...
                    feature_train, feature_test, target_train, target_test = train_test_split(feature_rsts['content'],
                                                                                              ...
                                                                                              test_size=0.33,
                                                                                              random_state=42)
                    dt_model = tree.DecisionTreeClassifier(criterion=numeric(params.get('criterion')),
                                                           ...
                                                           class_weight=numeric(params.get('class_weight')),
                                                           presort=numeric(params.get('presort')))
