...
def handle_get_clazzes():
    ...
    for user_clazz_relation in user_clazz_relations:
        ...
        user_clazz_relation.update({'number': UserClazzRelation().get_count(clazz_id=clazz['clazz_id']), 'clazz_name': clazz['clazz_name'], 'description': clazz['description'], 'invite_code': clazz['invite_code'], 'teacher_name': clazz['teacher_name'], 'create_time': clazz['create_time']})
