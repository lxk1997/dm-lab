...
class KMeansClusterContextMenu extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
        ...
        $.ajax({
            ...
            data: {
                ...
                params: JSON.stringify({
                    ...
                    init: values.init,
                    n_init: values.n_init,
                    tol: values.tol,
                    precompute_distances: values.precompute_distances,
...
export default withPropsAPI(KMeansClusterContextMenu);
