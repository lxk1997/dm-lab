...
class FeatureStructureContextMenu extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleRunThis = () => {
        ...
        $.ajax({
            ...
            data: {
                ...
                params: JSON.stringify({parent_id: parent_id, project_id: project_id, selected_columns: values.selected_columns, expression: values.expression, new_feature: values.new_feature})
            },
            success: (jsonData) => {
                if (jsonData.error) {
                    values.color = "#EE0000"
...
export default withPropsAPI(FeatureStructureContextMenu);
