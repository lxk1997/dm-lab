...
class LRClassifierContextMenu extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
        ...
        $.ajax({
            ...
            data: {
                ...
                params: JSON.stringify({
                    ...
                    intercept_scaling: values.intercept_scaling,
                    class_weight: values.class_weight === 'None' ? null: values.class_weight,
                    solver: values.solver,
                    max_iter: values.max_iter,
                    multi_class: values.multi_class,
                    l1_ratio: values.l1_ratio === 'None' ? null: values.l1_ratio,
                })
            },
            success: (jsonData) => {
                if (jsonData.error) {
...
export default withPropsAPI(LRClassifierContextMenu);
